...
<ul class="list-disc pl-5 space-y-2 mt-2">
  ...
  <li><strong>Discreet Hotel Outcalls:</strong> Fast doorstep delivery to hotels in Aerocity, Saket, and CP.</li>
    ...
    rateIntro: "Standard pricing applies based on short time or overnight stay. Always follow Cash on Delivery.",
  ...
  <li><strong>Prompt Doorstep Delivery:</strong> Outcall service across Suburbs and Town.</li>
    ...
    hindiText: `<p class="mb-4"><strong>Mumbai Call Girl Directory:</strong> Mumbai me verified independent models aur companions ke saath connect karein. Cash on Delivery aur zero advance payment.</p>`,
    profiles: []
  },
  ...
  <li><strong>Fast IT Hub Outcalls:</strong> Quick delivery to Hinjawadi, Baner, and Viman Nagar hotels.</li>
    ...
    rateIntro: "Fair market rates set by independent providers. Strictly cash on delivery.",
  ...
  <li><strong>Prompt Hotel Outcalls:</strong> Service across major tech parks and hotel zones.</li>
    ...
    faqs: [
      { q: "Is cash payment required on arrival in Bengaluru?", a: "Yes, we follow a strict cash-on-meeting policy." }
    ],
    hindiText: `<p class="mb-4"><strong>Bengaluru Call Girl Directory:</strong> Bengaluru me verified independent models ke saath connect karein. Cash on Delivery aur zero advance deposit.</p>`,
    profiles: []
  },
  ...
  <li><strong>Discreet Hotel Delivery:</strong> Fast outcall service to Park Street, Salt Lake, and Airport hotel zones.</li>
    ...
    rateIntro: "Transparent pricing negotiated directly with providers. Pay cash upon meeting.",
  ...
  <li><strong>IT Hub Hotel Delivery:</strong> Fast outcall service to Gachibowli, HITECH City, and Financial District.</li>
    ...
    rateIntro: "Fair market rates set independently by providers. Strictly cash on delivery.",
  ...
  <li><strong>Capital City Outcalls:</strong> Service across Panaji hotels and guest houses.</li>
    ...
    rateIntro: "Fair pricing determined by independent providers. Strictly cash on delivery.",
    ...
    hindiText: `<p class="mb-4"><strong>Panaji Call Girl Directory:</strong> Panaji Goa me verified independent companions ke saath direct connect karein. Cash on Delivery.</p>`,
    profiles: []
  },
  ...
  <li><strong>Prompt Hotel Outcalls:</strong> Fast doorstep delivery to hotels in Sector 17, 35, Mohali, and Zirakpur.</li>
    ...
    hindiText: `<p class="mb-4"><strong>Chandigarh Call Girl Directory:</strong> Chandigarh Tri-City (Mohali, Zirakpur) me verified companions ke saath safe date book karein. Cash on Delivery.</p>`,
    profiles: []
  },
  ...
  <li><strong>Resort Doorstep Service:</strong> Fast delivery to hotels and resorts around Lake Pichola and Fateh Sagar.</li>
    ...
    rateIntro: "Rates are set independently by providers. Always pay directly in cash after meeting.",
    ...
    hindiText: `<p class="mb-4"><strong>Udaipur Call Girl Directory:</strong> Udaipur (Lake City) me verified independent companions ke saath safe date book karein. Cash on Delivery.</p>`,
    profiles: []
  }
};
