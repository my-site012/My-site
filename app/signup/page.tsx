      ...
      <div className="relative w-full max-w-[420px]">
        ...
        <div className="relative bg-[#121212]/80 backdrop-blur-xl border border-white/10 p-8 md:p-10 rounded-3xl shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">Join CallGirl4U to post verified ads</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-3 text-white placeholder:text-gray-600 outline-none focus:border-red-500/50 focus:bg-white/10 transition-all font-medium"
                required
                disabled={loading}
              />
            </div>
